...
If you believe you've found a security issue in VertexWrite, please **do not** open a public GitHub issue.
...
VertexWrite is a desktop viewer/editor that:
...
- The user intentionally opening a local file they don't trust (VertexWrite is a local viewer; treat inputs accordingly).
